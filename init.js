...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        xhr = sbCorsRequest('GET', window.location.href + 'connector-to-analytics.php?type=chat_init&' + ('lang' in parameters ? '?lang=' + parameters['lang'] : '') + ('mode' in parameters ? ('lang' in parameters ? '&' : '?') + 'mode=' + parameters['mode'] : ''));
        if (!xhr) {
